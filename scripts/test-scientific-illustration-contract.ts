...
assert.match(routeSource, /generateBailianWanImage/);
assert.match(routeSource, /resolveMemberBailianProfile/);
...
console.log(JSON.stringify({
  ...
  checked: [
    ...
    'route preserves account scope, ai.image billing, member Bailian provider, persistence, preview, and download',
